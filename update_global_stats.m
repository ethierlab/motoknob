function global_stats = update_global_stats(rat_id,folder,trial_table,last_hit_thresh)
%
...
if exist(filename)
    ...
    up_global_stats.Properties.VariableNames = {'Start_time','Number_trials','Number_rewards','Mean_Peak','Initial_hit_thresh','Last_hit_thresh'};
    ...
    global_stats.Properties.VariableNames = {'Start_time','Number_trials','Number_rewards','Mean_Peak','Initial_hit_thresh','Last_hit_thresh'};
    save(filename,'global_stats');
